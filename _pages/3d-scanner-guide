...
The following information guides users through some of the basic steps and troubleshooting for using the 3D scanner and then printing out the object on the 3D printer. For a full step-by-step explanation, watch the embedded videos.<br>
